...
export interface ElectronAPI {
  ...
  /** 上传当前对话并生成分享链接 */
  shareConversation: (conversationId: string) => Promise<ChatShareResult>
  ...
  shareAgentSession: (sessionId: string) => Promise<ChatShareResult>
  ...
  /** 上传音频并转写 */
  transcribeVoiceDictationAudio: (input: VoiceDictationTranscribeAudioInput) => Promise<VoiceDictationTranscribeResult>
  /** 传入 URL 并转写 */
  transcribeVoiceDictationUrl: (input: VoiceDictationTranscribeUrlInput) => Promise<VoiceDictationTranscribeResult>
  /** 输出最终语音文本 */
...
const electronAPI: ElectronAPI = {
  ...
  shareConversation: (conversationId: string) => {
    return ipcRenderer.invoke(CHAT_IPC_CHANNELS.SHARE_CONVERSATION, conversationId)
  },
  ...
  shareAgentSession: (sessionId: string) => {
    return ipcRenderer.invoke(AGENT_IPC_CHANNELS.SHARE_SESSION, sessionId)
  },
  ...
  transcribeVoiceDictationAudio: (input: VoiceDictationTranscribeAudioInput) => {
    return ipcRenderer.invoke(VOICE_DICTATION_IPC_CHANNELS.TRANSCRIBE_AUDIO, input)
  },

  transcribeVoiceDictationUrl: (input: VoiceDictationTranscribeUrlInput) => {
    return ipcRenderer.invoke(VOICE_DICTATION_IPC_CHANNELS.TRANSCRIBE_URL, input)
  },
